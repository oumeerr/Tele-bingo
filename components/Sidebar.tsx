...
const Sidebar: React.FC<SidebarProps> = ({ onClose, onNavigate, currentLang, onLangChange, user }) => {
  return (
        ...
        <div className="bg-[#121212] p-10 text-white relative overflow-hidden border-b border-hb-border">
          <div className="relative z-10 flex flex-col items-center">
            <div className="w-24 h-24 rounded-[2rem] bg-hb-surface p-4 mb-5 shadow-inner border border-hb-border flex items-center justify-center">
              <img src="logo.png" className="w-16 h-16 object-contain" alt="logo" onError={(e) => {
                (e.target as HTMLImageElement).src = "https://api.dicebear.com/7.x/avataaars/svg?seed=HB";
              }} />
            </div>
